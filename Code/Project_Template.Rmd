...
```{r normalized.CO2 Emissions.country, echo=FALSE, message=FALSE, warning=FALSE}
knitr::opts_chunk$set(echo = TRUE)
...
```{r normalized.Renewable Energy Consumption.country, echo=FALSE, message=FALSE, warning=FALSE}
# Normalized to 2010 values for comparison
...
```{r normalized.PM2.5 Pollution Exposure.country, echo=FALSE, message=FALSE, warning=FALSE}
# Normalized to 2010 values for comparison
PM_normalized <- PM %>%
  group_by(`Country Code`) %>%
  mutate(Normalized = Value / first(Value))
...
```{r RQ1.1, echo=FALSE, message=FALSE, warning=FALSE}
knitr::opts_chunk$set(echo = TRUE)
...
```{r RQ2.1, echo=FALSE, message=FALSE, warning=FALSE}
