...
summary_table_Q2 <- data.frame(
  Country = c("Colombia", "China", "USA", "Germany"),
  Coefficient = c(coef(model_COL_Q2)[2], coef(model_CHN_Q2)[2], coef(model_USA_Q2)[2], coef(model_DEU_Q2)[2]),
...
```
The second set of linear regression models investigates the relationship between PM2.5 concentrations and CO2 emissions in each country. The USA and Germany show statistically significant results, but in opposite directions. For the USA, the coefficient is positive and highly significant (p = 0.0004), indicating that higher CO2 emissions are associated with increased PM2.5 levels. In contrast, Germany exhibits a significant negative relationship (p = 0.048), suggesting that higher CO2 emissions are associated with lower PM2.5 concentrations, which might reflect the influence of decarbonization technologies or cleaner combustion. However, the results for Colombia and China are not statistically significant, with p-values above 0.3 and very low R-squared values, implying little explanatory power of CO2 emissions on PM2.5 in these contexts. Overall, the findings underscore heterogeneous national dynamics, possibly driven by differing energy sources, pollution control technologies, and industrial policies.
...
ggplot(merged_pm_data, aes(x = Value_CO2, y = Value_PM, color = `Country Code`)) +
  ...
  labs(
    title = "CO₂ Emissions vs. PM2.5 Pollution Exposure (2000-2020)",
