...
```{r normalized.CO2 Emissions.country, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Normalized CO2 Emissions  (2010 = 1.0)"}
knitr::opts_chunk$set(echo = TRUE)
...
```{r normalized.Renewable Energy Consumption.country, echo=FALSE, message=FALSE, warning=FALSE,, fig.cap="Normalized Renewable Energy Consumption (2010 = 1.0)"}
# Normalized to 2010 values for comparison
...
```{r normalized.PM2.5 Pollution Exposure.country, echo=FALSE, message=FALSE, warning=FALSE,"Normalized PM2.5 Pollution Exposure (2010 = 1.0)" }
# Normalized to 2010 values for comparison
PM_normalized <- PM %>%
  group_by(`Country Code`) %>%
  mutate(Normalized = Value / first(Value))
...
```{r RQ1.1, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Cross Country Comparison of Renewable Energy Trends"}
knitr::opts_chunk$set(echo = TRUE)
...
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Renewable Energy Adoption vs. CO2 Emissions (2010-2020)"}
# Scatterplot with regression line
...
```{r RQ2.1, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Cross Country Comparison of PM2.5 Air Pollution"}
...
*Scatterplot with Regression Line
```{r RQ2.4, echo=FALSE, message=FALSE, warning=FALSE,fig.cap="CO2 Emissions vs. PM2.5 Pollution Exposure (2010-2020)"}
# Scatterplot
