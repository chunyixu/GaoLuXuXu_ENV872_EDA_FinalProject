...
The summary statistics for three indicators from 2010 to 2020 across four countries are demonstrated below as part of the data exploration. 
```{r setup, include=FALSE}
...
summary_stats <- Sus_Env_Processed %>%
...
knitr::kable(summary_stats, caption = "Summary Statistics for CO2, PM, and Renew", col.names = c("Series Name", "Observations", "Mean", "Max", "Min", "SD", "Range") , digits = 2)
